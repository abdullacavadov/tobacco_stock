...
<body class="sb-nav-fixed">
                                                ...
                                                <?php foreach ($rows as $row): ?>
                                                    ...
                                                    ?>
                                                        ...
                                                        <option value="<?= htmlspecialchars($row['id']) ?>">
                                                            <?= htmlspecialchars(
                                                                $row['type'] . ' (1kq mayası - ' . number_format($row['price'] / $row['stock'], 3) .
                                                                "₼, stokda: " .
                                                                number_format($row['stock'], 2) . 'kq | ' . date('d.m.Y', strtotime($row['created_at'])) . ")"
                                                            ) ?>
                                                        </option>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            const form = document.getElementById("create_sauce_order");
            ...
            form.addEventListener("submit", function (e) {
                ...
                fetch("./ajax/create_sauce_order.php", {
                    method: "POST",
                    body: formData
                })
